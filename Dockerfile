...
ADD ./resources/makeupdate.groovy /home/makeupdate.groovy
ADD ./resources/informix-jdbc-3.0.jar /usr/share/groovy/lib/informix-jdbc-3.0.jar
ADD ./resources/informix-jdbc-ext-3.0.jar /usr/share/groovy/lib/informix-ext-jdbc-3.0.jar
